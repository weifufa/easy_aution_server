<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="auctionId" header-align="center" align="center" label="拍品id">
      </el-table-column>
      <el-table-column prop="auctionName" header-align="center" align="center" label="拍卖品名称">
      </el-table-column>
      <el-table-column prop="auctionAmount" header-align="center" align="center" label="拍卖数量">
      </el-table-column>
      <el-table-column prop="startPrice" header-align="center" align="center" label="起拍价">
      </el-table-column>
      <el-table-column prop="auctionNumber" header-align="center" align="center" label="竞拍次数">
      </el-table-column>
      <el-table-column prop="maxPrice" header-align="center" align="center" label="最高价">
      </el-table-column>
...
<script>
import AddOrUpdate from './auction-add-or-update'
export default {
  data() {
    return {
      dataForm: {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/product/auction/list'),
        method: 'get',
